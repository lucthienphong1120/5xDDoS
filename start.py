...
def usge():
    usgeaseets()
    print('* LTP DDoS *')
    print('python3 {} <method> <url> <socks_type> <threads> <proxylist> <workers> <time>\n'.format(sys.argv[0]))
    print(' Methods:')
    print(' - Layer 3')
    ...
    print(' - All {} Method \n'.format(len(methodsl)))
    print('socks_type = [5, 4, 1]')
    print('threads: number of concurrent threads to attack')
    print('proxylist = socks5.txt')
    print('workers: number of concurrent workers to attack')
    print('time: time to attack (sec)')
    print('----------------------------------------')
    print('python3 start.py help to show this help')
